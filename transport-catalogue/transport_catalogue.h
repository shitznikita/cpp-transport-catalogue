...
namespace transport_catalogue {
    ...
    public:
        ...
        void SetDistanceBetweenStops(Stop* const stop1, Stop* const stop2, int distance);

        int GetDistanceBetweenStops(Stop* const stop1, Stop* const stop2) const;
    ...
    private:
        ...
        std::unordered_map<std::string_view, Stop* const> stopname_to_stop_;
        std::unordered_map<std::pair<Stop* const, Stop* const>, int, PairHasher, PairEqual> distance_between_stops_;
